...
public class Test {
  ...
  public static void main(String[] args) {
    final Setting setting = new Setting.SettingBuilder()
        .setNumOfAGVs(10).setSeed(9470394).setEndTime(2000000).build();
    // 20 9776449
...
//    final singlestage.contextaware.repair.AGVSystem agvSystem = new singlestage.contextaware.repair.AGVSystem(setting, true);
    agvSystem.run();
  }
