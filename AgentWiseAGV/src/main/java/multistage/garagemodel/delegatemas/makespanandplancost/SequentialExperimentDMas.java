...
public class SequentialExperimentDMas {
  ...
  public static void print(List<Sample> samples) {
    try {
      PrintWriter printWriterMS = new PrintWriter(new File("src/main/resources/ResultsMultiDMAS_makespan.txt"));
      ...
      PrintWriter printWriterPC = new PrintWriter(new File("src/main/resources/ResultsMultiDMAS_plancost.txt"));
