 ...
 */
public final class AGVRenderer2
  ...
  AGVRenderer2(CollisionGraphRoadModel m, ImmutableSet<VizOptions> options) {
    model = m;
  ...
  /**
   * @return A {@link Builder} for creating an {@link AGVRenderer2}.
   */
  @CheckReturnValue
  ...
  /**
   * A builder for creating {@link AGVRenderer2}s.
   * 
   * @author Rinde van Lon
   */
  @AutoValue
  public abstract static class Builder
      extends AbstractModelBuilder<AGVRenderer2, MovingRoadUser> {
    ...
    @Override
    public AGVRenderer2 build(DependencyProvider dp) {
      final CollisionGraphRoadModel rm = dp.get(CollisionGraphRoadModel.class);
      return new AGVRenderer2(rm, vizOptions());
    }

    static Builder create() {
      return new AutoValue_AGVRenderer2_Builder(
          Sets.immutableEnumSet(ImmutableSet.<VizOptions> of()));
    }

    static Builder create(VizOptions one, Iterable<VizOptions> more) {
      return new AutoValue_AGVRenderer2_Builder(Sets.immutableEnumSet(one,
  ...
  static class VehicleUI {
    ...
    Image createImage(GC gc, ViewPort vp) {
      ...
      igc.fillPolygon(new int[] { frontSize, 0, width - frontSize, 0, width,
          frontSize, 0, frontSize });
